...
import 'package:serverbox/src/presentation/widget/show_dialog.dart';
...
class ServerBoxListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final state = context.watch<ServerboxListCubit>().state;
    return Scaffold(
      appBar: AppBar(
                  ...
                  SlidableAction(
                    onPressed: (_) async {
                      await enterName(
                        ...
                        onPressed: () {
                          context.read<ServerboxListCubit>().editServerboxName(
                              serverBoxId: state.serverboxList[index].id);
